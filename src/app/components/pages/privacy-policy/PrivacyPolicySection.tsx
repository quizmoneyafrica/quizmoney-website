    ...
    <>
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-8">
          ...
          <p>
            Quiz Money (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is
            committed to protecting your privacy. This Privacy Policy explains
            how we collect, use, store, and share your personal information when
            you access or use our mobile application (the &quot;App&quot;). By
            using Quiz Money, you agree to this Privacy Policy.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-5">
            ...
            <li>
              Device Information: Model, OS, IP address, network carrier, unique
              identifiers.
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p>
            Your data is retained only as long as necessary to provide services
        ...
        <section className="mb-8">
          ...
          <p>
            Quiz Money is not for individuals under 18, and we do not knowingly
