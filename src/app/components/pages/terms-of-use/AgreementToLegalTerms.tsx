...
export default function AgreementToLegalTerms() {
  return (
    <PageLayout>
      <div className=" w-full pb-28">
        ...
        <div className="space-y-6 text-black text-sm md:text-lg leading-8 md:leading-[60px]">
          ...
          QuizMoney (&apos;Company&apos;, &apos;we&apos;, &apos;us&apos;, or
          &apos;our&apos;), a company registered in Nigeria.We operate the
          website https://quizmoney.ng (the &apos;Site&apos;), the mobile
          application QuizMoney (the &apos;App&apos;), as well as any other
          related products and services that refer or link to these legal terms
          (the &apos;Legal Terms&apos;) (collectively, the
          &apos;Services&apos;). These Legal Terms constitute a legally binding
          agreement made between you, whether personally or on behalf of an
          entity (&apos;you&apos;), and QM Technologies, concerning your access
          ...
          DISCONTINUE USE IMMEDIATELY.We will provide you with prior notice of
          any scheduled changes to the Services you are using. The modified
          Legal Terms will become effective upon posting or notifying you by
          admin@qmtech.org, as stated in the email message. By continuing to use
          the Services after the effective date of any changes, you agree to be
          bound by the modified terms.The Services are intended for users who
